...
public class CustomerDTO {
    ...
    @UniqueValue(fieldName = "phoneNumber", entityClass = Customer.class, message = "This phone number is already registered")
    ...
    @UniqueValue(fieldName = "email", entityClass = Customer.class, message = "This email address is already registered")
